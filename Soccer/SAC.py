...
def train(device: str):
    ...
    value_nets = [ValueNet().to(device) for _ in range(2 * game_manager.SoccerState.NUM_AGENTS)]
    target_value_nets = [ValueNet().to(device) for _ in range(2 * game_manager.SoccerState.NUM_AGENTS)]
